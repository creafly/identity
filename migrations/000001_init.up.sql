...
ALTER TABLE users
ADD CONSTRAINT fk_users_blocked_by FOREIGN KEY (blocked_by) REFERENCES users (id);
...
CREATE INDEX idx_tenants_is_blocked ON tenants (is_blocked)
WHERE
    is_blocked = true;
