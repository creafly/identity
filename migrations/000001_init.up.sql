...
-- Add self-referencing foreign key for blocked_by
...
-- User roles (many-to-many: users <-> system roles)
...
-- User claims (many-to-many: users <-> claims)
...
-- Role claims (many-to-many: roles <-> claims)
...
-- Assign global admin claims to system 'admin' role
