...
type Messages struct {
	...
	EmailVerification EmailVerificationMessages `json:"emailVerification"`
}
...
type AuthMessages struct {
	...
	LogoutAllSuccess string `json:"logoutAllSuccess"`
...
type EmailVerificationMessages struct {
	CodeSent            string `json:"codeSent"`
	VerificationSuccess string `json:"verificationSuccess"`
	AlreadyVerified     string `json:"alreadyVerified"`
	InvalidCode         string `json:"invalidCode"`
	CodeExpired         string `json:"codeExpired"`
	TooManyRequests     string `json:"tooManyRequests"`
}
...
func getHardcodedFallback() *Messages {
	return &Messages{
		...
		TOTP: TOTPMessages{
			...
			Locked:               "Too many failed verification attempts. Please try again later.",
		},
		User: UserMessages{
		...
		EmailVerification: EmailVerificationMessages{
			...
			TooManyRequests:     "Too many requests. Please wait before requesting a new code",
		},
	}
}
