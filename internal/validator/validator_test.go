...
func TestValidatePassword(t *testing.T) {
	tests := []struct {
		...
		{"valid with upper+lower+number", "Secur1ty", true},
		{"valid with upper+lower+special", "Secure!!", true},
		{"valid with upper+number+special", "SECURE1!", true},
		{"valid with lower+number+special", "secure1!", true},
		{"valid with all 4 types", "MyP@ssw0rd!", true},
		{"too short", "Pass1!", false},
		{"too long (73 chars)", "Abcdefgh1!" + strings.Repeat("a", 63), false},
		{"max length 72 valid", "Abcdefgh1!" + strings.Repeat("a", 62), true},
		{"only upper+lower (2 types)", "SecureABC", false},
		{"only upper+number (2 types)", "SECURE123", false},
		{"only lower+number (2 types)", "secure123", false},
		{"empty", "", false},
		{"only numbers", "12345678", false},
		{"only lowercase", "abcdefgh", false},
		{"only uppercase", "ABCDEFGH", false},
		{"common password exact match", "password", false},
		{"common password password1", "password1", false},
		{"common password password123", "password123", false},
		{"8 chars with 3 types", "Secur1!!", true},
	}
