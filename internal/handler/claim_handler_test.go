...
func (m *TenantServiceMock) BlockTenant(ctx context.Context, id uuid.UUID, reason string, blockedBy uuid.UUID) error {
	return nil
}
func (m *TenantServiceMock) UnblockTenant(ctx context.Context, id uuid.UUID) error {
	return nil
}
